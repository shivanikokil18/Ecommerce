class Api::V1::ProductsController < ApiController
  ...
  def show
    ...
    render json: { message: 'Loaded required product', data: product }
  end
  ...
  def update
    ...
    if product.update(product_params)
      render json: { message: "updated sucessfully", data: product }
    else
      render json: { message: "Product not updated" }, status: 422
    end
  end
  ...
  def destroy
    ...
    if product.destroy
      ...
      render json: { message: "can not delete product" }, status: 422
    end
  end
