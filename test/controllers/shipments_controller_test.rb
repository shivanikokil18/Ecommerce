...
class ShipmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipment" do
    assert_difference('Shipment.count') do
      post shipments_url, params: { shipment: { details: @shipment.details, order_id: @shipment.order_id, shipment_date: @shipment.shipment_date } }
    end
  ...
  test "should update shipment" do
    patch shipment_url(@shipment), params: { shipment: { details: @shipment.details, order_id: @shipment.order_id, shipment_date: @shipment.shipment_date } }
